const App = {
        ...
        <div style="width:75%">
            <el-tabs type="border-card">
                <el-tab-pane label="Operaciones">
                    ...
                    <el-row justify="space-between" style="align-items: center; margin-bottom: 1rem">
                        <el-col :span="18">Categorías</el-col>
                        <el-col :span="4">
                            <el-button :loading="synchronizingCategories" @click="onSynchronizeCategories">Sincronizar</el-button>
                        </el-col>
                    </el-row>
                    <el-row justify="space-between" style="align-items: center; margin-bottom: 1rem">
                    ...
                    <el-row justify="space-between" style="align-items: center; margin-bottom: 1rem">
                        ...
                        <el-col :span="4">
                            <el-button :loading="synchronizingAsignCategoriesWithTemplates"  @click="onSynchronizeAsignCategoriesWithTemplates">Sincronizar</el-button>
                        </el-col>
                    </el-row>
                    <el-row justify="space-between" style="align-items: center; margin-bottom: 1rem">
    ...
    data() {
        return {
            ...
            synchronizingAsignCategoriesWithTemplates: false,
    ...
    methods:{
        ...
        async onSynchronizeCategories() {
            this.synchronizingCategories = true
            const res = await axios.get(window.pedidosInternet.synchronizeCategories)
            this.synchronizingCategories = false
        },
        ...
        async onSynchronizeAsignCategoriesWithTemplates(){
            this.synchronizingAsignCategoriesWithTemplates = true
            const res = await axios.get(window.pedidosInternet.synchronizeAsignCategoriesWithTemplates)
            this.synchronizingAsignCategoriesWithTemplates = false
        },
